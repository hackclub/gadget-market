...
If you don't need to use PCBA (ie: not having your board components assembled by JLC), there are only two options you need to choose: the color of your PCB, and the surface finish. The color doesn't matter, so choose what you aesthetically want! For the surface finish, please choose LeadFree Hasl. ENIG is significantly more expensive :"D
...
If you're getting PCB Assembly, you also need to upload a BOM (Bill of Materials) and CPL (Component Placement List) to JLC. 

Read JLC's guidelines on how to prepare those files in KiCad [here](https://jlcpcb.com/help/article/how-to-generate-the-bom-and-centroid-file-from-kicad), as well as recommendations for those files [here](https://jlcpcb.com/help/article/advice-for-bom-and-cpl-files-preparation).